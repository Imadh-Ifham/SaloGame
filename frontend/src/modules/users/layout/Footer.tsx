    ...
    <footer className="mt-auto w-full  py-6 px-4 sm:px-6 lg:px-8 mx-auto border-t border-green-400 bg-transparent backdrop-blur-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 items-center gap-6 md:gap-5 text-center md:text-left">
        ...
        <div className="flex justify-center md:justify-start">
          <a
            className="flex-none text-xl font-semibold text-green-600 focus:outline-none"
            href="#"
            aria-label="Brand"
          >
            <img src="/icon-main.svg" alt="Logo" className="w-10 h-auto" />
          </a>
        </div>
        {/* End Col */}
        ...
        <div className="flex justify-center md:justify-end space-x-4">
          <a
            className="w-10 h-10 flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-gray-500 hover:bg-green-100 focus:outline-none focus:bg-green-100"
            href="#"
          >
            <svg
