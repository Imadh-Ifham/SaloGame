...
export default function EditMembershipTypeModal({
  ...
  return (
    <div className="fixed inset-0 scrollbar-hide bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white dark:bg-gray-800 p-6 scrollbar-hide rounded-lg shadow-xl w-full max-w-md max-h-[90vh] overflow-y-auto">
