  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow border border-gray-200 dark:border-gray-700">
      ...
      {paginatedRenewals.length === 0 ? (
        ...
        <>
          <div className="overflow-x-auto scrollbar-hide bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
            <table className="min-w-full scrollbar-hide divide-y divide-gray-200 dark:divide-gray-700">
